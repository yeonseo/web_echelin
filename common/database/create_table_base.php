        ...
        switch ($table_name) {
            ...
            case 'seller':
                $sql = "CREATE TABLE `seller` (
                  ...
                  `seller_uptae_nm` varchar(100) NULL,
...
function insert_table($con, $table_name)
{
    switch ($table_name) {
        ...
        case 'seller':
            $sql = "INSERT INTO `seller` (`seller_num`, `user_id`, `business_license`, `store_name`, `store_type`, `store_address`, `store_postcode`, `store_lat`, `store_lon`, `convenient_facilities`, `introduction`, `break_start`, `break_end`, `nokids`, `opening_day`, `opening_hours_start`, `opening_hours_end`, `store_tel`, `special_note`, `max_reserv_time_num_of_people`, `max_reserv_month`, `intensity_of_reserv`,  `seller_uptae_nm`, `keywords`) VALUES
              (null, 'infor15', '6618700621', '지수네', '한식', '경기 고양시 일산서구 후곡로 55,(일산동, 후곡마을2단지아파트)', '10372','37.68226978304604', '126.76502696497245', '식당 내부 화장실,아기 의자', '엄마가 해준 밥이 먹고 싶다면 여기로 오세염', '15 : 00', '17 : 00', false, '2008-12-31', '09 : 00', '22 : 00', '010-2828-8705', null, 5, '3개월', '상', null, null),
              (null, 'donuni', '2198500014', '동운이네', '한식', '서울 은평구 가좌로9길 3-1, (응암동)', '03484','37.59014145683352', '126.91664312076006', '식당 내부 화장실', '뜨끄은한 국밥이 먹고 싶다면 동운이네로 커몬', '', '', false, '2019-09-18', '09 : 00', '22 : 00', '02-542-8705', '주차 공간이 협소합니다.', 10, '2개월', '중', null, null),
              (null, 'yeonseo', '3033300514', '연서네', '양식', '경기 고양시 일산서구 후곡로 55,(일산동, 후곡마을2단지아파트)', '10372','37.68226978304604', '126.76502696497245', '식당 내부 화장실,아기 의자', '엄마가 해준 밥이 먹고 싶다면 여기로 오세염', '15:00:00', '17:00:00', false, '2008-12-31', '09 : 00', '22 : 00', '010-2828-8705', '주차 공간이 협소합니다.', 5, '3개월', '상', null, null),
              (null, 'sumgmini', '2208166003', '성민이네', '아시아음식', '서울 은평구 가좌로9길 3-1, (응암동)', '03484','37.59014145683352', '126.91664312076006', '식당 내부 화장실', '뜨끄은한 국밥이 먹고 싶다면 동운이네로 커몬', '', '', false, '2019-09-18', '09 : 00', '22 : 00', '02-542-8705', '주차 공간이 협소합니다.', 10, '2개월', '중', null, null),
              (null, 'mugweon', '1358504288 ', '무권이네', '일식', '경기 고양시 일산서구 후곡로 55,(일산동, 후곡마을2단지아파트)', '10372','37.68226978304604', '126.76502696497245', '식당 내부 화장실,아기 의자', '엄마가 해준 밥이 먹고 싶다면 여기로 오세염', '15:00:00', '17:00:00', false, '2008-12-31', '09 : 00', '22 : 00', '010-2828-8705', '주차 공간이 협소합니다.', 5, '3개월', '상', null, null),
              (null, 'youngsam032', '1198703184', '영삼이네', '분식', '서울 은평구 가좌로9길 3-1, (응암동)', '03484','37.59014145683352', '126.91664312076006', '식당 내부 화장실', '뜨끄은한 국밥이 먹고 싶다면 동운이네로 커몬', '', '', false, '2019-09-18', '09 : 00', '22 : 00', '02-542-8705', '주차 공간이 협소합니다.', 10, '2개월', '중', null, null),
              (null, 'patri@gmail.com', '2148884534', '스타벅스', '카페', '경기 고양시 일산서구 후곡로 55,(일산동, 후곡마을2단지아파트)', '10372','37.68226978304604', '126.76502696497245', '식당 내부 화장실,아기 의자', '엄마가 해준 밥이 먹고 싶다면 여기로 오세염', '15:00:00', '17:00:00', false, '2008-12-31', '09 : 00', '22 : 00', '010-2828-8705', '주차 공간이 협소합니다.', 5, '3개월', '상', null, null),
              (null, 'tls1577@nate.com', '1108151144', '커피빈', '카페', '서울 은평구 가좌로9길 3-1, (응암동)', '03484','37.59014145683352', '126.91664312076006', '식당 내부 화장실', '뜨끄은한 국밥이 먹고 싶다면 동운이네로 커몬', '', '', false, '2019-09-18', '09 : 00', '22 : 00', '02-542-8705', '주차 공간이 협소합니다.', 10, '2개월', '중', null, null),
              (null, 'hadong302@gmail.com', '7781400532', '카페베네', '카페', '경기 고양시 일산서구 후곡로 55,(일산동, 후곡마을2단지아파트)', '10372','37.68226978304604', '126.76502696497245', '식당 내부 화장실,아기 의자', '엄마가 해준 밥이 먹고 싶다면 여기로 오세염', '15 : 00', '17 : 00', false, '2008-12-31', '09 : 00', '22 : 00', '010-2828-8705', '주차 공간이 협소합니다.', 5, '3개월', '상', null, null),
              (null, 'dmswl@hanmail.net', '7905000239', '엽기떡볶이', '분식', '서울 은평구 가좌로9길 3-1, (응암동)', '03484','37.59014145683352', '126.91664312076006', '식당 내부 화장실', '뜨끄은한 국밥이 먹고 싶다면 동운이네로 커몬', '', '', false, '2019-09-18', '09 : 00', '22 : 00', '02-542-8705', '주차 공간이 협소합니다.', 10, '2개월', '중', null, null),
              (null, 'ksm03071@naver.com', '1018126409', '신전떡볶이', '분식', '경기 고양시 일산서구 후곡로 55,(일산동, 후곡마을2단지아파트)', '10372','37.68226978304604', '126.76502696497245', '식당 내부 화장실,아기 의자', '엄마가 해준 밥이 먹고 싶다면 여기로 오세염', '15 : 00', '17 : 00', false, '2008-12-31', '09 : 00', '22 : 00', '010-2828-8705', '주차 공간이 협소합니다.', 5, '3개월', '상', null, null),
              (null, 'mu338666@naver.com', '1018676277', '매드포갈릭', '양식', '서울 은평구 가좌로9길 3-1, (응암동)', '03484','37.59014145683352', '126.91664312076006', '식당 내부 화장실', '뜨끄은한 국밥이 먹고 싶다면 동운이네로 커몬', '', '', false, '2019-09-18', '09 : 00', '22 : 00', '02-542-8705', '주차 공간이 협소합니다.', 10, '2개월', '중', null, null),
              (null, 'infor01', '6768600102', '엽기꼼닭발', '닭발', '서울 성동구 왕십리로22길 3,(도선동)', '10372','37.68226978304604', '126.76502696497245', '식당 내부 화장실,아기 의자', '엄마가 해준 밥이 먹고 싶다면 여기로 오세염', '15 : 00', '17 : 00', false, '2008-12-31', '09 : 00', '22 : 00', '010-2828-8705', '주차 공간이 협소합니다.', 5, '3개월', '상', null, null),
              (null, 'infor02', '2208162517', '동운이엄마네', '한식', '서울 은평구 가좌로9길 3-1, (응암동)', '03484','37.59014145683352', '126.91664312076006', '식당 내부 화장실', '뜨끄은한 국밥이 먹고 싶다면 동운이네로 커몬', '', '', false, '2019-09-18', '09 : 00', '22 : 00', '02-542-8705', '주차 공간이 협소합니다.', 10, '2개월', '중', null, null),
              (null, 'infor03', '2148107770', '지수네', '한식', '경기 고양시 일산서구 후곡로 55,(일산동, 후곡마을2단지아파트)', '10372','37.68226978304604', '126.76502696497245', '식당 내부 화장실,아기 의자', '엄마가 해준 밥이 먹고 싶다면 여기로 오세염', '15 : 00', '17 : 00', false, '2008-12-31', '09 : 00', '22 : 00', '010-2828-8705', '주차 공간이 협소합니다.', 5, '3개월', '상', null, null),
              (null, 'infor04', '1418601172', '동운이네', '한식', '서울 은평구 가좌로9길 3-1, (응암동)', '03484','37.59014145683352', '126.91664312076006', '식당 내부 화장실', '뜨끄은한 국밥이 먹고 싶다면 동운이네로 커몬', '', '', false, '2019-09-18', '09 : 00', '22 : 00', '02-542-8705', '주차 공간이 협소합니다.', 10, '2개월', '중', null, null),
              (null, 'infor05', '1098199153', '지수네', '한식', '경기 고양시 일산서구 후곡로 55,(일산동, 후곡마을2단지아파트)', '10372','37.68226978304604', '126.76502696497245', '식당 내부 화장실,아기 의자', '엄마가 해준 밥이 먹고 싶다면 여기로 오세염', '15 : 00', '17 : 00', false, '2008-12-31', '09 : 00', '22 : 00', '010-2828-8705', '주차 공간이 협소합니다.', 5, '3개월', '상', null, null),
              (null, 'infor06', '2068629161', '동운이네', '한식', '서울 은평구 가좌로9길 3-1, (응암동)', '03484','37.59014145683352', '126.91664312076006', '식당 내부 화장실', '뜨끄은한 국밥이 먹고 싶다면 동운이네로 커몬', '', '', false, '2019-09-18', '09 : 00', '22 : 00', '02-542-8705', '주차 공간이 협소합니다.', 10, '2개월', '중', null, null),
              (null, 'infor07', '1208607029', '지수네', '한식', '경기 고양시 일산서구 후곡로 55,(일산동, 후곡마을2단지아파트)', '10372','37.68226978304604', '126.76502696497245', '식당 내부 화장실,아기 의자', '엄마가 해준 밥이 먹고 싶다면 여기로 오세염', '15 : 00', '17 : 00', false, '2008-12-31', '09 : 00', '22 : 00', '010-2828-8705', '주차 공간이 협소합니다.', 5, '3개월', '상', null, null),
              (null, 'infor08', '2018121515', '동운이네', '한식', '서울 은평구 가좌로9길 3-1, (응암동)', '03484','37.59014145683352', '126.91664312076006', '식당 내부 화장실', '뜨끄은한 국밥이 먹고 싶다면 동운이네로 커몬', '', '', false, '2019-09-18', '09 : 00', '22 : 00', '02-542-8705', '주차 공간이 협소합니다.', 10, '2개월', '중', null, null),
              (null, 'infor09', '1322802823', '지수네', '한식', '경기 고양시 일산서구 후곡로 55,(일산동, 후곡마을2단지아파트)', '10372','37.68226978304604', '126.76502696497245', '식당 내부 화장실,아기 의자', '엄마가 해준 밥이 먹고 싶다면 여기로 오세염', '15 : 00', '17 : 00', false, '2008-12-31', '09 : 00', '22 : 00', '010-2828-8705', '주차 공간이 협소합니다.', 5, '3개월', '상', null, null),
              (null, 'infor10', '5042236813', '동운이네', '한식', '서울 은평구 가좌로9길 3-1, (응암동)', '03484','37.59014145683352', '126.91664312076006', '식당 내부 화장실', '뜨끄은한 국밥이 먹고 싶다면 동운이네로 커몬', '', '', false, '2019-09-18', '09 : 00', '22 : 00', '02-542-8705', '주차 공간이 협소합니다.', 10, '2개월', '중', null, null),
              (null, 'infor11', '2018613311', '지수네', '한식', '경기 고양시 일산서구 후곡로 55,(일산동, 후곡마을2단지아파트)', '10372','37.68226978304604', '126.76502696497245', '식당 내부 화장실,아기 의자', '엄마가 해준 밥이 먹고 싶다면 여기로 오세염', '15 : 00', '17 : 00', false, '2008-12-31', '09 : 00', '22 : 00', '010-2828-8705', '주차 공간이 협소합니다.', 5, '3개월', '상', null, null),
              (null, 'infor12', '4328700251', '동운이네', '한식', '서울 은평구 가좌로9길 3-1, (응암동)', '03484','37.59014145683352', '126.91664312076006', '식당 내부 화장실', '뜨끄은한 국밥이 먹고 싶다면 동운이네로 커몬', '', '', false, '2019-09-18', '09 : 00', '22 : 00', '02-542-8705', '주차 공간이 협소합니다.', 10, '2개월', '중', null, null),
              (null, 'infor13', '3978100320', '지수네', '한식', '경기 고양시 일산서구 후곡로 55,(일산동, 후곡마을2단지아파트)', '10372','37.68226978304604', '126.76502696497245', '식당 내부 화장실,아기 의자', '엄마가 해준 밥이 먹고 싶다면 여기로 오세염', '15 : 00', '17 : 00', false, '2008-12-31', '09 : 00', '22 : 00', '010-2828-8705', '주차 공간이 협소합니다.', 5, '3개월', '상', null, null),
              (null, 'infor14', '1293854815 ', '동운이네', '한식', '서울 은평구 가좌로9길 3-1, (응암동)', '03484','37.59014145683352', '126.91664312076006', '식당 내부 화장실', '뜨끄은한 국밥이 먹고 싶다면 동운이네로 커몬', '', '', false, '2019-09-18', '09 : 00', '22 : 00', '02-542-8705', '주차 공간이 협소합니다.', 10, '2개월', '중', null, null),
              (null, 'infor16', '1198703184 ', '동운이네', '한식', '서울 은평구 가좌로9길 3-1, (응암동)', '03484','37.59014145683352', '126.91664312076006', '식당 내부 화장실', '뜨끄은한 국밥이 먹고 싶다면 동운이네로 커몬', '', '', false, '2019-09-18', '09 : 00', '22 : 00', '02-542-8705', '주차 공간이 협소합니다.', 10, '2개월', '중', null, null),
              (null, 'infor17', '2148859748 ', '동운이네', '한식', '서울 은평구 가좌로9길 3-1, (응암동)', '03484','37.59014145683352', '126.91664312076006', '식당 내부 화장실', '뜨끄은한 국밥이 먹고 싶다면 동운이네로 커몬', '', '', false, '2019-09-18', '09 : 00', '22 : 00', '02-542-8705', '주차 공간이 협소합니다.', 10, '2개월', '중', null, null),
              (null, 'infor18', '6178148252 ', '동운이네', '한식', '서울 은평구 가좌로9길 3-1, (응암동)', '03484','37.59014145683352', '126.91664312076006', '식당 내부 화장실', '뜨끄은한 국밥이 먹고 싶다면 동운이네로 커몬', '', '', false, '2019-09-18', '09 : 00', '22 : 00', '02-542-8705', '주차 공간이 협소합니다.', 10, '2개월', '중', null, null),
              (null, 'infor19', '2208792541', '동운이네', '한식', '서울 은평구 가좌로9길 3-1, (응암동)', '03484','37.59014145683352', '126.91664312076006', '식당 내부 화장실', '뜨끄은한 국밥이 먹고 싶다면 동운이네로 커몬', '', '', false, '2019-09-18', '09 : 00', '22 : 00', '02-542-8705', '주차 공간이 협소합니다.', 10, '2개월', '중', null, null);
          ";
            break;
