                    ...
                    <div style="width: 82%;
                        ...
                        <div class="about_me3">
                            ...
                            <span class="text_move">
                                <?=$username?></span>
                            <button id="name_input" type="button" class="update_button">수정하기</button> <br>
                            ...
                            <span class="text_move">
                                <?=$userpass?></span>
                            <button id="name_input" type="button" class="update_button_2">수정하기</button> <br>
