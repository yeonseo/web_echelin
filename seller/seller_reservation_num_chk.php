 ...
 <div class="right_content">
     ...
     <div class="container">
       ...
       <div class="my_comment_title">
         <span class="comment_title_sub">상점 관리 &nbsp&nbsp > &nbsp&nbsp 예약 관리 페이지</span><br><br>
...
?>
        <div class="show_btn_div">
            <button class='btn_store_update' onclick="location.href='./seller_reservation_manage.php?seller_num=<?=$seller_num?>'">예약관리</button>
        </div>
